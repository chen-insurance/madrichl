...
const CATEGORY_SEO: Record<string, CategorySeoContent> = {
  ...
  "employer-insurance": {
    intro: "ביטוח אחריות מקצועית מגן על עצמאים ועסקים מפני תביעות בגין רשלנות מקצועית. מטפלים, רופאים, עורכי דין, יועצים ועסקים — כולם זקוקים לכיסוי מתאים. המדריכים שלנו יסבירו מה כיסוי הכרחי לכם.",
    faq: [
