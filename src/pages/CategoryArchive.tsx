...
const CATEGORY_SEO: Record<string, CategorySeoContent> = {
  ...
  "car-insurance": {
    ...
    faq: [
      ...
      { q: "מהו סעיף דירוג וכיצד הוא חוסך כסף?", a: "סעיף דירוג (או סעיף זכות) מעניק הנחה בפרמיה לאחר שנה ללא תביעה — מ-30% ועד 75-80% לאחר 10 שנים. שמרו על סעיף הדירוג שלכם: שקלו שלא להגיש תביעה על נזקים קטנים שיכולים לעלות פחות מאיבוד ההנחה." },
    ],
  },
  "property-insurance": {
