...
async function upsertArticle(article) {
  ...
  return new Promise((resolve, reject) => {
    const req = https.request({ hostname: HOST, path: "/functions/v1/manage-article", method: "POST", headers: { "Content-Type": "application/json; charset=utf-8", "x-admin-secret": ADMIN, Authorization: `Bearer ${ANON}`, "Content-Length": buf.length } }, (res) => {
...
async function run() {
  console.log("\n\u2550\u2550 Linking \u2014 Mortgage Insurance ══\n");
  await addSeeAlso("life-insurance-mortgage-guide-2026", [
    ["\u05d1\u05d9\u05d8\u05d5\u05d7 \u05de\u05e9\u05db\u05e0\u05ea\u05d0 2026 \u2014 \u05d4\u05de\u05d3\u05e8\u05d9\u05da \u05d4\u05de\u05dc\u05d0", "mortgage-insurance-complete-guide-2026"],
  ]);
  await addSeeAlso("home-insurance-guide-2026", [
    ["\u05d1\u05d9\u05d8\u05d5\u05d7 \u05de\u05e9\u05db\u05e0\u05ea\u05d0 2026 \u2014 \u05d7\u05d9\u05d9\u05dd + \u05de\u05d1\u05e0\u05d4", "mortgage-insurance-complete-guide-2026"],
  ]);
  await addSeeAlso("life-insurance-price-guide-2026", [
    ["\u05d1\u05d9\u05d8\u05d5\u05d7 \u05de\u05e9\u05db\u05e0\u05ea\u05d0 \u2014 \u05d0\u05d9\u05da \u05dc\u05d7\u05e1\u05d5\u05da 30%", "mortgage-insurance-complete-guide-2026"],
  ]);
  console.log("\n\u2550\u2550 \u05e1\u05d9\u05d5\u05dd! ══\n");
}
